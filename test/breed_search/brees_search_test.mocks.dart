...
// in pet_discovery_app/test/breed_search/brees_search_test.dart.
...
class _FakeApiResulte_6<T> extends _i1.SmartFake implements _i8.ApiResulte<T> {
  _FakeApiResulte_6(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
///
/// See the documentation for Mockito's code generation for more information.
class MockHomeRepo extends _i1.Mock implements _i11.HomeRepo {
  @override
  _i9.Future<_i8.ApiResulte<List<_i12.Breed>>> getBreeds({
    required int? limit,
    required int? page,
  }) =>
      (super.noSuchMethod(
